...
@section('styles1')
    ...
    <link rel="stylesheet" href="{{asset('assets/css/Animated-Pretty-Product-List-v12.css')}}">
            ...
            @foreach ($companies as $singleCompany)
                <div class="col-sm-6 col-md-4 product-item animation-element slide-top-left">
                    ...
                    <div class="thumb-content">
                                        @if($singleCompany->logo)<a  href="{{ route('company', [$singleCompany->id]) }}"><img class="card-img-top img-fluid" style="width:200px;height:200px" src="{{ $singleCompany->logo->getUrl() }}"/></a>@endif
                     </div>
                        <div class="row">
                            <div class="col-8">
                            <h4 class="card-title"><a class="text-decoration-none link-dark" href="{{ route('company', [$singleCompany->id]) }}">{{$singleCompany->name}}</a></h4>
                            </div>
