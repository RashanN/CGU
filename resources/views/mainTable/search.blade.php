            ...
            @if (count($companies) > 0)
                ...
                <div class="col-sm-6 col-md-4 product-item animation-element slide-top-left">
                    <div class="product-container">
                        <div class="row">
                        @if($company->logo)<a href="{{ route('company', [$company->id]) }}"><img class="card-img-top img-fluid" src="{{ $company->logo->getUrl() }}"/></a>@endif
                        </div>
                        <div class="row">
                            <div class="col-8">
                                <h2><a href="{{ route('company', [$company->id]) }}">{{$company->name}}</a></h2>
                            </div>
                            
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <p class="product-description">{{ substr($company->description, 0, 100) }}...</p>
