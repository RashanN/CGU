    ...
    <div class="container">
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                ...
                <input type="text" name='instagram' class="form-control {{$errors->first('instagram') ? "is-invalid" : "" }} " value="{{old('instagram') ? old('instagram') : $general->instagram}}" id="instagram" placeholder="Youtube">
        ...
        <div class="form-group ml-5">
            ...
            <label for="sharethis" class="col-sm-2 col-form-label">Footer description</label>
        ...
        <div class="form-group ml-5">
            ...
            <label for="gverification" class="col-sm-2 col-form-label">Navigation bar color</label>

            <div class="col-sm-7">

                <input type="color" name='gverification' class="form-control {{$errors->first('gverification') ? "is-invalid" : "" }} " value="{{old('gverification') ? old('gverification') : $general->gverification}}" id="footer" placeholder="Navigation bar color">
